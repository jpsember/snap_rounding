...
//        Streams.out.println("epsdoc, maxX="+maxX);
...
//      clipX0 =  x0;clipY0 =  y0;clipX1 =  x1; clipY1 =  y1;
    ...
    public synchronized void write(Writer writer) throws IOException {
        ...
        if (clip != null) {
          minX = MyMath.clamp(minX,clip.x,clip.endX());
          maxX = MyMath.clamp(maxX,clip.x,clip.endX());
          minY = MyMath.clamp(minY,clip.y,clip.endY());
          maxY = MyMath.clamp(maxY,clip.y,clip.endY());
        }
        double offsetX = -minX;
        double offsetY = -minY;
